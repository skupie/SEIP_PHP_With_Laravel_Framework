                ...
                <div class="card card-body">
                    ...
                    <form action="action.php" method="POST">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="number" value="<?php echo isset($_GET['first-number']) ? $_GET['first-number'] : ''; ?>"  class="form-control" name="first_number"  />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <lable class="col-md-3">Second Number</lable>
                            <div class="col-md-9">
                                <input type="number" value="<?php echo isset($_GET['second-number']) ? $_GET['second-number'] : ''; ?>"  class="form-control" name="second_number"  />
                            </div>
                        </div>
                        <div class="row mb-3">
